...
public:
	double optimalShootingDistance = 10; // optimal distance from powerport to shoot from
	...
	void VisionSteerController(double angleError, double distance, std::shared_ptr<rev::CANPIDController> pidControllerL, std::shared_ptr<rev::CANPIDController> pidControllerR);
